...
#ifndef CUSTOM_INTERFACES__SRV__DETAIL__TRIANGLE__FUNCTIONS_H_
#define CUSTOM_INTERFACES__SRV__DETAIL__TRIANGLE__FUNCTIONS_H_
...
/// Initialize srv/Triangle message.
/**
...
/// Create srv/Triangle message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__Triangle_Request__init().
...
/// Destroy srv/Triangle message.
/**
 * It calls
 * custom_interfaces__srv__Triangle_Request__fini()
...
/// Check for srv/Triangle message equality.
/**
...
/// Initialize array of srv/Triangle messages.
/**
...
/// Finalize array of srv/Triangle messages.
/**
 * It calls
 * custom_interfaces__srv__Triangle_Request__fini()
...
/// Create array of srv/Triangle messages.
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__Triangle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Triangle messages.
/**
 * It calls
 * custom_interfaces__srv__Triangle_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Triangle message array equality.
/**
...
/// Copy an array of srv/Triangle messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_interfaces__srv__Triangle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__Triangle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It allocates the memory for the array and calls
 * custom_interfaces__srv__Triangle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
...
/**
 * It calls
 * custom_interfaces__srv__Triangle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_INTERFACES__SRV__DETAIL__TRIANGLE__FUNCTIONS_H_
